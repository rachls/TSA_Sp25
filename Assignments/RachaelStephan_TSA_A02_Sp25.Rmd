...
Both the total biomass energy production and the total renewable energy production increases over time. These two time series show similar trends to each other in which they go through a period of increase, followed by a stable period, and then another upward trend. The biomass timeseries appears to have a steep reduction in energy production in 2020 but then continues with the positive trend afterwards. The renewable energy timeseries has a slight decrease in 2020 as well, but it is not as pronounced. 
