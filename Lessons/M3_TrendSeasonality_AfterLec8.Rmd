...
print(cor(inflow_data_yearly$inflow_data,my_year,method="pearson"))
...
print(adf.test(inflow_data_yearly$inflow_data,alternative = "stationary")) #stationary over stochastic trend
