...
```{r}
clean_wind_data_fun2 <- forecast::na.interp(ts_wind_data)  #object should be a time series
...
```{r}
clean_wind_data_fun3 <- zoo::na.approx(ts_wind_data)  #object should be a time series
