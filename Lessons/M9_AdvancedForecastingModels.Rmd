...
Hybrid function that is decomposed with a STL approach. The seasonal components are removed and fit with ETS. Then forecast with ETS and add back seasonal data. 
...
ARIMA_Four_fit <- auto.arima(ts_act_power_daily_train, 
                             seasonal=FALSE, 
                             lambda=0,
                             xreg=fourier(ts_act_power_daily_train, #when you want to add terms that are not part of 
                                          K=c(2,12))          #the timeseries or errors, such as supplementary factors
                             )
